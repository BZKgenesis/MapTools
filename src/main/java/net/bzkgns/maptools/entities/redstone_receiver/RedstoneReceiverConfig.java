...
public record RedstoneReceiverConfig(
                ...
                String displayName,
                boolean xrayVisible) {
        public static final StreamCodec<ByteBuf, RedstoneReceiverConfig> CONFIG_STREAM_CODEC = StreamCodec.of(
                        (buf, config) -> {
                        ...
                        buf -> new RedstoneReceiverConfig(
                                        ...
                                        ByteBufCodecs.BOOL.decode(buf)));
        public static final Codec<RedstoneReceiverConfig> CONFIG_CODEC = RecordCodecBuilder.create(instance -> instance
                        .group(
                                        ...
                                        Codec.STRING.fieldOf("display_name")
                                                        .forGetter(RedstoneReceiverConfig::displayName),
                                        Codec.BOOL.fieldOf("xray_visible")
                                                        .forGetter(RedstoneReceiverConfig::xrayVisible))
