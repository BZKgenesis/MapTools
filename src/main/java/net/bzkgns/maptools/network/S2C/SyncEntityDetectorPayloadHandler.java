...
public class SyncEntityDetectorPayloadHandler implements IPayloadHandler<SyncEntityDetectorPayload> {

    @Override
    public void handle(@NotNull SyncEntityDetectorPayload data, IPayloadContext context) {
        context.enqueueWork(() -> {
