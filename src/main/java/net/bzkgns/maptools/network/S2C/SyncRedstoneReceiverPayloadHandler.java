...
public class SyncRedstoneReceiverPayloadHandler implements IPayloadHandler<SyncRedstoneReceiverPayload> {

    @Override
    public void handle(@NotNull SyncRedstoneReceiverPayload data, IPayloadContext context) {
        context.enqueueWork(() -> {
