...
import net.bzkgns.maptools.network.S2C.*;
...
public class Maptools {
    ...
    public Maptools(IEventBus modEventBus, ModContainer modContainer) {
        ...
        ModEntityDataSerializers.REGISTRAR.register(modEventBus);
        ModDataComponents.register(modEventBus);

        // Register ourselves for server and other game events we are interested in.
        // Note that this is necessary if and only if we want *this* class (Maptools) to
    ...
    public void registerPayload(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(
                SyncRedstoneReceiverPayload.TYPE,
                SyncRedstoneReceiverPayload.STREAM_CODEC,
                new SyncRedstoneReceiverPayloadHandler());
        ...
        registrar.playToClient(
                SyncEntityDetectorPayload.TYPE,
                SyncEntityDetectorPayload.STREAM_CODEC,
                new SyncEntityDetectorPayloadHandler());
    }
}
